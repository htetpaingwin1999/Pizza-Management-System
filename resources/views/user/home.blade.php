                    ...
                    <div class="col-4 mb-5">
                        <div class="card h-100" style="width: 270px">
                            ...
                            @if ($item->buy_one_get_one_status == 1)
                                <div class="badge bg-danger text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Buy 1 Get One</div>
                            @endif
                            <!-- Product image-->
                            <img class="card-img-top" id="pizza-image" src="{{ asset('uploads/'.$item->image) }}" alt="..." height="200px"/>
                            <!-- Product details-->
